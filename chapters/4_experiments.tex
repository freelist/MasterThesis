...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/4_experiments/3d_reconst_ex0}
    \caption{\textbf{Stereo matching based 3D reconstruction example}: (left column) input FlexSight sensor left images, (right column) output estimated point-cloud.}
    \label{fig:3d_reconst_ex0}
\end{figure}
