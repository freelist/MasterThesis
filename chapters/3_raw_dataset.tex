\chapter{The RAW Dataset}\label{ch:raw_dataset}
...
%which more details are given in the Appendix \ref{apx:robocupatwork},
...
\begin{itemize}
	\item \textbf{19 industry relevant objects}: no discriminative color, no texture, often similar in shape;
